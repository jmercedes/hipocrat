...
Refinery::Pages.configure do |config|
  ...
  config.default_parts = ["Body", "Side Body", "slideshow", "home_services", "staff_medico"]
  ...
  config.layout_template_whitelist = [:application,:home, :show, :services, :board, :job, :bio_detail, :ecard_layout, :ecard]
